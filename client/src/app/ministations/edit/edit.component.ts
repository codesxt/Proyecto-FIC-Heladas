...
export class EditComponent implements OnInit {
  ...
  loadData(){
    this.miniStationsService.getControllerNode(this.id)
    .subscribe(
      response => {
        this.controllerNode = {
        ...
        this.stations = response.attributes.stations;
      },
      error => {
        this.notificationsService.error('Error', 'Ocurrió un error al cargar los datos de la estación.');
      }
    )
  }
  ...
  save(){
    ...
    this.miniStationsService.updateControllerNode(this.id, controllerNode)
    .subscribe(
      data => {
        this.notificationsService.success('Actualización Exitosa', 'El nodo controlador fue actualizado exitosamente.');
      },
      error => {
        this.notificationsService.error('Error', 'Ocurrió un error al actualizar el nodo controlador.');
        console.log(error);
      }
    )
  }
